...
const Ui5ExtensionMocker_1 = require("../../../scripts/hooks/utils/Ui5ExtensionMocker");
/**
 * @class browser
 * @memberof util
 */
class Browser {
    constructor() {
        this.vlf = new verboseLogger_1.VerboseLoggerFactory("util", "browser");
        this.specLogPrefix = "@SPEC: ";
     ...
     */
    async sleepAndCollectCoverage(duration = 5000) {
     ...
     */
    async clearBrowser(clearLocal = true, clearSession = true, clearCookies = true) {
     ...
     */
    async getUI5Version(timeout = browser.config.waitForUI5Timeout || 5000) {
     ...
     */
    async switchToNewWindow(titleOrUrl, timeout = 10000) {
    ...
    async log(message = "") {
        ...
        await browser.execute((message) => console.log(message), message);
    }
    /**
     * @function warn
     * @memberOf util.browser
    ...
    async warn(message = "") {
        ...
        message = this.specLogPrefix + message;
        await browser.execute((message) => console.warn(message), message);
    }
    /**
     * @function error
     * @memberOf util.browser
    ...
    async error(message) {
        ...
        message = this.specLogPrefix + message;
        await browser.execute((message) => console.error(message), message);
    }
    // =================================== HELPER ===================================
    async _verifyTitleOrUrl(titleOrUrl) {
