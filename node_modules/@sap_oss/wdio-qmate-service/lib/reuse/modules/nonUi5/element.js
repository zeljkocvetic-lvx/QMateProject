...
class ElementModule {
    constructor() {
        this.vlf = new verboseLogger_1.VerboseLoggerFactory("nonUi5", "element");
     ...
     */
    async waitForAll(selector, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false) {
     ...
     */
    async getAllDisplayed(selector, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
     ...
     */
    async getAll(selector, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
     ...
     */
    async getByCss(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false) {
     ...
     */
    async getByCssContainingText(selector, text = "", index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false, strict = false) {
     ...
     */
    async getById(id, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false) {
     ...
     */
    async getByClass(elemClass, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false) {
     ...
     */
    async getByName(name, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false) {
     ...
     */
    async getByXPath(xpath, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false) {
     ...
     */
    async getByChild(elementSelector, childSelector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false) {
     ...
     */
    async getByParent(elementSelector, parentSelector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false) {
     ...
     */
    async isPresentByCss(css, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
     ...
     */
    async isPresentByXPath(xpath, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
     ...
     */
    async getCssPropertyValue(elementOrSelector, cssProperty) {
    ...
    // =================================== HELPER ===================================
    async _waitForStabilization(selector, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false, stableIterationsRequired = 3) {
    ...
    async _getAndFilterElementBySelector(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden = false) {
