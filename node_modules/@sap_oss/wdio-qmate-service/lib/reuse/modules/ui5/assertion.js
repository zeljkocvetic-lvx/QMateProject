...
class Assertion {
    constructor() {
        this.vlf = new verboseLogger_1.VerboseLoggerFactory("ui5", "assertion");
     ...
     */
    async expectAttributeToBe(selector, attribute, compareValue, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
        ...
        try {
            ...
            this.ErrorHandler.logException(!error.stack?.includes(this.expectAttributeToBe.name) ? new Error() : error, error.message);
        }
     ...
     */
    async expectAttributeToContain(selector, attribute, compareValue, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
     ...
     */
    async expectTextToBe(selector, compareValue, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
     ...
     */
    async expectValueToBe(selector, compareValue, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
     ...
     */
    async expectValueToBeDefined(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
     ...
     */
    async expectToBeNotEnabled(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
     ...
     */
    async expectToBeEnabled(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
     ...
     */
    async expectValidationError(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
     ...
     */
    async expectValidationSuccess(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
     ...
     */
    async expectCssPropertyValueToBe(selector, cssProperty, compareValue, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
     ...
     */
    async expectBindingPathToBe(selector, attribute, compareValue, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
     ...
     */
    async expectBindingContextPathToBe(selector, compareValue, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
        ...
        try {
            ...
            return this.ErrorHandler.logException(!error.stack?.includes("expectBindingContextPathToBe") ? new Error() : error, error.message);
        }
        let value = null;
        if (typeof loadPropertyTimeout === "string") {
            loadPropertyTimeout = parseInt(loadPropertyTimeout);
     ...
     */
    async expectToBeVisible(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT, loadPropertyTimeout = process.env.LOAD_PROPERTY_TIMEOUT || 10000) {
        ...
        try {
            ...
            return this.ErrorHandler.logException(!error.stack?.includes(this.expectToBeVisible.name) ? new Error() : error, error.message);
        }
        let value = null;
        if (typeof loadPropertyTimeout === "string") {
            loadPropertyTimeout = parseInt(loadPropertyTimeout);
     ...
     */
    async expectToBeVisibleInViewport(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
        ...
        try {
            ...
            this.ErrorHandler.logException(!error.stack?.includes(this.expectToBeVisibleInViewport.name) ? new Error() : error, error.message);
        }
        let value = null;
        await browser.waitUntil(async function () {
     ...
     */
    async expectToBeNotVisible(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
     ...
     */
    async expectMessageToastTextToBe(text, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
    ...
    _throwAttributeError(attribute) {
