...
class Control {
    constructor() {
        this.vlf = new verboseLogger_1.VerboseLoggerFactory("ui5", "control");
        this.lib = require("../../../scripts/hooks/utils/lib");
        this.locatorCommands = require("../../../scripts/hooks/utils/locatorCommands");
    }
    // =================================== EXECUTE ===================================
    /**
     * @function execute
     ...
     * }, selector, args);
     **/
    async execute(callbackFunction, selectorOrElement, args) {
     ...
     */
    async focus(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
