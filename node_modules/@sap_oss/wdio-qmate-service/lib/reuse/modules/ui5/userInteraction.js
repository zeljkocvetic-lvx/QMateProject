...
class UserInteraction {
    constructor() {
        // =================================== LOGGER===================================
        this.vlf = new verboseLogger_1.VerboseLoggerFactory("ui5", "click");
    ...
    async _clearHelper(selector, index = 0, timeout = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT) || constants_1.GLOBAL_DEFAULT_WAIT_TIMEOUT) {
        let id, elem;
        if (selector) {
            await ui5.userInteraction.click(selector, index, timeout);
...
// =================================== CONSTANTS ===================================
UserInteraction.TEXTAREA_METADATA = "sap.m.TextArea";
UserInteraction.TEXTAREA_MACROS_METADATA = "sap.fe.macros.field.TextAreaEx";
UserInteraction.SUPPORTED_TEXTAREA_METADATA = [UserInteraction.TEXTAREA_METADATA, UserInteraction.TEXTAREA_MACROS_METADATA];
