...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> Service.js</h1>
        <div class='clearfix'>
...
&nbsp;
    Object.defineProperty(this, "defaultSchema", {
      get: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >metadata.model.getSchema(),</span>
    });
  }
&nbsp;
  /**
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (arguments.length === 0) {
