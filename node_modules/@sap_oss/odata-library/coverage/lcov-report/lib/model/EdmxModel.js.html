...
<head>
    <title>Code coverage report for lib/model/EdmxModel.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/model</a> EdmxModel.js</h1>
        <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!CsdlSchema) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Edmx version '${version}' is not supported.`);</span>
    }
&nbsp;
    return CsdlSchema;
  }
