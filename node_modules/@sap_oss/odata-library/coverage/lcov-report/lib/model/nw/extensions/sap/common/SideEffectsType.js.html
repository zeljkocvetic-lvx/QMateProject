...
<head>
    <title>Code coverage report for lib/model/nw/extensions/sap/common/SideEffectsType.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../../index.html">All files</a> / <a href="index.html">lib/model/nw/extensions/sap/common</a> SideEffectsType.js</h1>
        <div class='clearfix'>
...
&nbsp;
    SideEffectsType._.definePropertyCollection(this, "SourceEntities", (p) =&gt;
      p ? entityType.getNavigationProperty(p, settings.strict) : <span class="branch-1 cbranch-no" title="branch not covered" >entityType</span>
    );
    ...
    SideEffectsType._.definePropertyCollection(
      ...
      (p) =&gt; {
        ...
        if (isNavigationProperty) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (navigationObject) {
