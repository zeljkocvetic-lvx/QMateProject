...
<head>
    <title>Code coverage report for lib/model/nw/dataSource/EntitySet.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">lib/model/nw/dataSource</a> EntitySet.js</h1>
        <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.entityType.sap.semantics === "parameters") {
