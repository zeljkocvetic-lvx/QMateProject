...
<head>
    <title>Code coverage report for lib/model/nw/dataSource/FunctionImportParameter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">lib/model/nw/dataSource</a> FunctionImportParameter.js</h1>
        <div class='clearfix'>
...
&nbsp;
    if (!["In", "Out", "InOut"].includes(mode)) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (schema.settings.strict !== false) {
