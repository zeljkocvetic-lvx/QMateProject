...
<head>
    <title>Code coverage report for lib/agent/log.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/agent</a> log.js</h1>
        <div class='clearfix'>
...
module.exports.logResponse = function (logger, counter, requestUrl, opts, res) {
  logger.debug(
    `Response #${counter}\t${
      opts.method || <span class="branch-1 cbranch-no" title="branch not covered" >"GET"</span>
