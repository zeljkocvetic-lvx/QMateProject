...
<head>
    <title>Code coverage report for lib/agent/settings.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/agent</a> settings.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>80/81</span>
            </div>
...
<a name='L490'></a><a href='#L490'>490</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  if (definition) {
    if (!(_.get(parameters, "url") || "").match(/^https/)) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (missingKeys.length &gt; 0) {
