...
<head>
    <title>Code coverage report for lib/agent/parsers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/agent</a> parsers.js</h1>
        <div class='clearfix'>
...
parsers["application/json"] = function parseJSON(res, done) {
  ...
  res.on("end", () =&gt; {
    ...
    try {
      ...
      err = e;
      err.rawResponse = res.text || <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
