...
<head>
    <title>Code coverage report for lib/agent/authentication/headers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">lib/agent/authentication</a> headers.js</h1>
        <div class='clearfix'>
    ...
    agent
      ...
      .then((res) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (authBasic.isValidResponse(res)) {
          ...
          let err = <span class="cstat-no" title="statement not covered" >new Error("Authentication by headers failed.");</span>
