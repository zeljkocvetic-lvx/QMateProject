...
<head>
    <title>Code coverage report for lib/agent/authentication/samlSap.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">lib/agent/authentication</a> samlSap.js</h1>
        <div class='clearfix'>
      ...
      .map((formParameter) =&gt; {
        if (
          formParameter.name.match(
            /username$/ || <span class="branch-1 cbranch-no" title="branch not covered" >formParameter.name.match(/password$/)</span>
          )
        ) {
          loginForm = true;
        }
        formParameter.value = formParameter.value || <span class="branch-1 cbranch-no" title="branch not covered" >"";</span>
