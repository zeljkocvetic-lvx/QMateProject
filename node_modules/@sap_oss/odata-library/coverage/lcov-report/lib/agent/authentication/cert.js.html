...
<head>
    <title>Code coverage report for lib/agent/authentication/cert.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">lib/agent/authentication</a> cert.js</h1>
        <div class='clearfix'>
...
function authenticate(settings, agent, endpointUrl) {
  return new Promise((resolve, reject) =&gt; {
    agent
      .fetch(endpointUrl)
      .then((res) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (authBasic.isValidResponse(res)) {
          resolve(res);
        } else {
          let err = <span class="cstat-no" title="statement not covered" >new Error("Client certification authentification failed.");</span>
