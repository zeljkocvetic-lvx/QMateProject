...
<head>
    <title>Code coverage report for lib/agent/Agent.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/agent</a> Agent.js</h1>
        <div class='clearfix'>
...
<a name='L772'></a><a href='#L772'>772</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  initializeLogger(settings) {
    let logger = {
      trace: <span class="fstat-no" title="function not covered" >()</span> =&gt; {},
      debug: <span class="fstat-no" title="function not covered" >()</span> =&gt; {},
      info: () =&gt; {},
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isObject(headers)) {
...
&nbsp;
   ...
   * @memberof Agent
   */
  batch(batch, raw = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
    let batchNormalized = batch || <span class="branch-1 cbranch-no" title="branch not covered" >this.batchManager.defaultBatch;</span>
    let payload;
&nbsp;
...
&nbsp;
   ...
   */
  fetch(requestUrl, opts = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    let normalizedOpts;
