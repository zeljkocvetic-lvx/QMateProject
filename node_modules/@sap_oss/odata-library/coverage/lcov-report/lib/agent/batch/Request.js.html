...
<head>
    <title>Code coverage report for lib/agent/batch/Request.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">lib/agent/batch</a> Request.js</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  body() {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.content) {
      throw new Error(
