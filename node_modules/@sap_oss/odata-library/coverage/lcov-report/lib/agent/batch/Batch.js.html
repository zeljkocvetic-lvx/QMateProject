...
<head>
    <title>Code coverage report for lib/agent/batch/Batch.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">lib/agent/batch</a> Batch.js</h1>
        <div class='clearfix'>
        ...
        _.chain(batchResponseText)
          ...
          .reduce((acc, row) =&gt; {
            if (row === `--${boundary}`) {
              ...
              <span class="missing-if-branch" title="else path not taken" >E</span>if (acc.length) {
                promises.push(
                  this.requests[acc.length - 1].process(acc[acc.length - 1])
                );
              }
