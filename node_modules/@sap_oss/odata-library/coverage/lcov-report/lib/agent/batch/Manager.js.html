...
<head>
    <title>Code coverage report for lib/agent/batch/Manager.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">lib/agent/batch</a> Manager.js</h1>
        <div class='clearfix'>
...
&nbsp;
    id = _.get(batch, "id");
    <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isString(id)) {
...
&nbsp;
  get defaultChangeSet() {
    return this.defaultBatch ? this.defaultBatch.defaultChangeSet : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
  }
}
&nbsp;
