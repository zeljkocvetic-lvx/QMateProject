...
<head>
    <title>Code coverage report for lib/agent/url.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/agent</a> url.js</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (additionalSearch) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isString(inputPath) &amp;&amp; inputPath.substring(0, 1) === "/") {
