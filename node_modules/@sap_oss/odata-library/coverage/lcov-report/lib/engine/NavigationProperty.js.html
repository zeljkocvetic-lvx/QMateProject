...
<head>
    <title>Code coverage report for lib/engine/NavigationProperty.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/engine</a> NavigationProperty.js</h1>
        <div class='clearfix'>
...
&nbsp;
   ...
   * @memberof NavigationProperty
   */
<span class="fstat-no" title="function not covered" >  ge</span>tSingleResourcePath() {
    let keyProperties;
    let keyPredicate;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.isMultiple()) {</span>
<span class="cstat-no" title="statement not covered" >      keyProperties = this.keyProperties(this.defaultRequest._keyValue);</span>
<span class="cstat-no" title="statement not covered" >      keyPredicate = this.keyPredicate(keyProperties);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return `${this.getListResourcePath()}(${keyPredicate})`;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return this.getListResourcePath();</span>
    }
  }
&nbsp;
  /**
   ...
   * @memberof NavigationProperty
   */
<span class="fstat-no" title="function not covered" >  ge</span>tListResourcePath() {
<span class="cstat-no" title="statement not covered" >    return `${this.source.getSingleResourcePath()}/${</span>
