...
<head>
    <title>Code coverage report for lib/engine/entitySet/Filter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">lib/engine/entitySet</a> Filter.js</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  toURIComponent() {
    let encodedFilter;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isString(this.definition)) {
