...
<head>
    <title>Code coverage report for lib/engine/QueryableResource.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/engine</a> QueryableResource.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>50/59</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>131/144</span>
            </div>
...
<a name='L652'></a><a href='#L652'>652</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
   ...
   * @memberof QueryableResource
   */
<span class="fstat-no" title="function not covered" >  ge</span>t(...args) {
<span class="cstat-no" title="statement not covered" >    return this.defaultRequest.get(...args);</span>
  }
&nbsp;
  /**
  ...
  post(body) {
    ...
    let path = urlQuery
      ? <span class="branch-0 cbranch-no" title="branch not covered" >`/${this.getListResourcePath()}?${urlQuery}`</span>
...
&nbsp;
  ...
  processUpdateCall(methodName, ...args) {
    ...
    let defaultChangeSet = this.agent.batchManager.defaultChangeSet;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (args.length === 0 || args.length &gt; 2) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Invalid body parameter for ${methodName}.`);</span>
...
&nbsp;
   ...
   * @memberof QueryableResource
   */
<span class="fstat-no" title="function not covered" >  de</span>lete(properties) {
    let defaultBatch = <span class="cstat-no" title="statement not covered" >this.agent.batchManager.defaultBatch;</span>
    let defaultChangeSet = <span class="cstat-no" title="statement not covered" >this.agent.batchManager.defaultChangeSet;</span>
    let path;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (arguments.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >      this.key(properties);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    path = `/${this.getSingleResourcePath()}`;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return defaultBatch</span>
      ? this._handleBatchCall(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >          this.defaultRequest.header("If-Match", "*");</span>
<span class="cstat-no" title="statement not covered" >          return defaultBatch.delete(</span>
            path,
            this.defaultRequest._headers,
            defaultChangeSet
          );
        }, defaultBatch)
      : this._handleAgentCall(<span class="fstat-no" title="function not covered" >(r</span>equest) =&gt; {
<span class="cstat-no" title="statement not covered" >          request.header("If-Match", "*");</span>
<span class="cstat-no" title="statement not covered" >          return this.agent.delete(path, request._headers);</span>
        });
  }
&nbsp;
  /**
...
&nbsp;
  ...
  processNavigationProperties(entityTypeProperties, entityTypeModel) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isObject(entityTypeModel)) {
...
&nbsp;
   ...
   * @memberof QueryableResource
   */
<span class="fstat-no" title="function not covered" >  cr</span>eateNavigationProperty() {}
&nbsp;
  /**
  ...
  _handleAgentCall(call, requestDefinition) {
    let request = requestDefinition || <span class="branch-1 cbranch-no" title="branch not covered" >this.defaultRequest;</span>
&nbsp;
    this.reset();
&nbsp;
