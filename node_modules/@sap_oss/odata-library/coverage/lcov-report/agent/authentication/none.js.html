...
<head>
    <title>Code coverage report for agent/authentication/none.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">agent/authentication</a> none.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >          resolve(response);</span>
        } else {
