 ...
 */
declare class SimpleLocationModule extends SimpleModuleBase {
    /**
 ...
 */
declare class LocationModule extends SimpleLocationModule {
    protected readonly faker: Faker;
    constructor(faker: Faker);
    /**
